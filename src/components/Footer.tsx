        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              With 25 years of experience as an LIC agent, I provide expert guidance for all your insurance and investment needs.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="bg-gray-800 p-2 rounded-full hover:bg-[#005DA6] transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="ml-3 text-gray-400">123 Insurance Tower, MG Road, New Delhi, India - 110001</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-[#F7CB05] flex-shrink-0" />
                <span className="ml-3 text-gray-400">+91 98765 43210</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-[#F7CB05] flex-shrink-0" />
                <span className="ml-3 text-gray-400">anil.kumar@licagent.com</span>
              </li>
            </ul>
            <div className="mt-6">
              <a 
        ...
        <div className="container mx-auto px-4 md:px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Anil Kumar LIC Agent. All rights reserved.
            </p>
            <div className="flex items-center space-x-4">
              <a href="#" className="text-gray-400 hover:text-[#F7CB05] text-sm transition-all">Privacy Policy</a>
              <span className="text-gray-600">|</span>
              <a href="#" className="text-gray-400 hover:text-[#F7CB05] text-sm transition-all">Terms of Service</a>
              <span className="text-gray-600">|</span>
              <a href="#" className="text-gray-400 hover:text-[#F7CB05] text-sm transition-all">LIC Official</a>
            </div>
          </div>
        </div>
      </div>
